...
#         The figure object to display in Streamlit.
#     """
...
#     # Increase figure height slightly to ensure charts aren't squashed
...
#     # Do NOT close the figure here; return it so Streamlit can use it.
#     # The caller (app.py) will handle display.
#     return fig
